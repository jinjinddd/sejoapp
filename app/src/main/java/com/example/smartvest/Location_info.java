...
public class Location_info extends AppCompatActivity {
    ...
    private static final String TAG = Location_info.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent intent = new Intent(Location_info.this, WelcomActivity.class);
            Location_info.this.startActivity(intent);

        }
        else
        {

            Intent intent = new Intent(Location_info.this, adminActivitiy.class);
            Intent intent2 = new Intent(Location_info.this, Location_info.class);
            Location_info.this.startActivity(intent);
        }
        ...
        settingsClient.checkLocationSettings(builder.build())
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(Location_info.this);
                        fusedLocationProviderClient.requestLocationUpdates(locationRequest, locationCallback, null);
                    }
                })
                .addOnFailureListener(Location_info.this, new OnFailureListener() {
                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(Location_info.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            String userID = getIntent().getStringExtra("userID");
            Double str_latitude = latitude;
            Double str_longitude = longitude;
            ...
            RequestQueue queue = Volley.newRequestQueue(Location_info.this);
            queue.add(workerlocationRequest);



           // Intent intent = new Intent(Location_info.this, MainActivity.class);
